...
CREATE TABLE IF NOT EXISTS users (
  ...
  bio TEXT NULL,
  role ENUM('user','unconfirmed','artist','manager','admin','editor','suspended','banned') NOT NULL DEFAULT 'user',
...
CREATE TABLE IF NOT EXISTS auth_challenges (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  user_id INT UNSIGNED NOT NULL,
  purpose ENUM('login', 'password_reset', 'email_verify', 'account_delete') NOT NULL,
  channel ENUM('email', 'totp') NOT NULL DEFAULT 'email',

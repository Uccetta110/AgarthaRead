<template>
  <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    <div v-else-if="pending" class="text-slate-500">Caricamento del libro...</div>
    <div v-else-if="!item" class="text-slate-500">Libro non trovato.</div>
    <div v-else class="space-y-6">
      <div class="grid gap-6 lg:grid-cols-[320px_1fr]">
        ...
        <div class="space-y-4">
          ...
          <div class="rounded-2xl border border-slate-200 bg-slate-50 p-6" v-if="item.bodyHtml">

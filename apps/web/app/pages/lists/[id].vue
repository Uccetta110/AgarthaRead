  ...
  <div>
    ...
    <section class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/80">
      ...
      <div v-else>
        ...
        <div class="mt-4">
          <button class="mr-2 rounded bg-sky-600 px-3 py-1 text-white dark:bg-sky-500" @click="saveOrder">Salva ordine</button>
          <a
            :href="exportUrl"
            class="inline-flex items-center rounded bg-slate-100 px-3 py-1 text-slate-700 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700"
            target="_blank"
            rel="noreferrer"
          >
            Esporta JSON
